...
<div class="noidung">
    ...
    <p style="text-align:center">
        <a href="{{ asset('images/banner/dongho.jpg') }}" class="example-image-link countimg0" data-lightbox="example-1"><img alt="" src="{{ asset('images/banner/dongho.jpg') }}" style="height:333px; width:500px" data-lightbox="roadtrip"></a>
    </p>
